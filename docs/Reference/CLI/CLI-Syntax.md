...
events are displayed on the console, and errors and other information are logged to a file. The
log file location can be specified with the [`--log-file`](#log-file) command-line option.
