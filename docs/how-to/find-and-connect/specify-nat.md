...
Manually configure your firewall to allow external hosts to create inbound connections to Teku on all
[P2P ports](../../concepts/p2p-networking.md#p2p-options), including the QUIC transport UDP port.
