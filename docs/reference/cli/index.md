...
When set to `false`, Teku subscribes to 2 persistent subnets regardless of the number of validators. Teku will also subscribe and unsubscribe from subnets as needed for the running validators.
